...
%     set(ax,'FontName', 'Times New Roman', 'FontSize', 22, 'FontWeight', 'bold')
    ...
    plot(cAxis, maxDepth_D200_NA039*MC.mus, '-', 'Color', Red1, 'LineWidth', 2, 'MarkerSize', 5);  hold on;
%     plot(cAxis, maxDepth_D100_NA039, '-', 'Color', colorList(round(mW/4),:), 'LineWidth', 1, 'MarkerSize', 5);  hold on;    
